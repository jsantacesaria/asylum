					...
					<div class="grid-style">
							...
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<p>Asylum Members Only</p>
										<h2>Login</h2>
									</header>
									<p>Asylum Social Club Members login to the private site here </p>
						...
						<div>
							<div class="box">
								...
								<div class="content">
									<header class="align-center">
										<p>Interested in Asylum?</p>
										<h2>Contact Us</h2>
									</header>
									<p>Interested in becoming an Asylum member? Please contact us.</p>
									<footer class="align-center">
				...
				<li><a href="https://www.instagram.com/asylum_buffalo/?hl=en" class="icon fa-instagram" target="_blank"><span class="label">Instagram</span></a></li>
						<li><a href= "mailto: asylumbuffalo@gmail.com" class="icon fa-envelope-o" target="_blank"><span class="label">Email</span></a></li>
                         ...
                         <div class="ncsf_partner">
                          <img src="/images/ncsf_partner.png" style="width:200px;height:100px;">
                         </div>
